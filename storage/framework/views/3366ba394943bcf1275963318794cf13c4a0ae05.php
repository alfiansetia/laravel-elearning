...
<div class="container">
    <div class="row">
        <div class="col-md-8 mx-auto">
            <p class="text-center">CStudy is not just another online learning platform; it's an interactive journey into the world of coding designed especially for beginners. We understand that learning to code can be challenging, so we've incorporated gamification to make the process engaging and enjoyable.</p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\fegen\Documents\GitHub\CstudySkripsi\resources\views/pages/about.blade.php ENDPATH**/ ?>